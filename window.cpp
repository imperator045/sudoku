...
void Window::event_loop()
{
    ...
    while(gin >> ev && ev.keycode!=key_escape)
    {
        ...
        if(helyes) gout<<move_to(0,0)<<color(64,75,77)<<box(_sx,_sy)<<move_to(_sx/2-_sx*0.3, _sy/3)<<color(255,170,53)<<font("LiberationSans-Regular.ttf",30)<<text("Megoldottad a sudokut!");
        gout<<refresh;
    }
}
