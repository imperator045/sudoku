...
void Spinbox::draw()
{
    ...
    //<<move_to(_posx+_sizex*0.8, _posy+_sizey*0.2)<<color(210,210,210)<<box(_sizex*0.15,_sizey*0.3)<<move_to(_posx+_sizex*0.8+_sizex*0.15*0.15, _posy+_sizey*0.2+_sizey*0.3*0.1)<<color(0,0,0)<<font("LiberationSans-Regular.ttf",_sizey*0.3)<<text('+')
    //<<move_to(_posx+_sizex*0.8, _posy+_sizey*0.6)<<color(210,210,210)<<box(_sizex*0.15,_sizey*0.3)<<move_to(_posx+_sizex*0.8+_sizex*0.15*0.15, _posy+_sizey*0.55+_sizey*0.3*0.1)<<color(0,0,0)<<text('-')
